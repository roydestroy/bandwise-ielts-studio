...
export const providers={
 openai:{name:'OpenAI',textModel:'gpt-4.1',audioModel:'gpt-audio',audio:true,pdf:true,help:'https://platform.openai.com/api-keys'},
 gemini:{name:'Gemini',textModel:'gemini-2.5-flash',audioModel:'gemini-2.5-flash',audio:true,pdf:true,help:'https://aistudio.google.com/apikey'},
 claude:{name:'Claude',textModel:'claude-sonnet-5',audioModel:'',audio:false,pdf:true,help:'https://platform.claude.com/settings/keys'},
 qwen:{name:'Qwen',textModel:'qwen3.5-omni-plus',audioModel:'qwen3.5-omni-plus',audio:true,pdf:true,help:'https://www.alibabacloud.com/help/en/model-studio/get-api-key'}
} as const;
